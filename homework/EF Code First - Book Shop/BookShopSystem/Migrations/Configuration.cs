...
namespace BookShopSystem.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<BookShopContext>
    {
        ...
        {
            string[] authors = File.ReadAllLines(@"C:\softuni\Databases Advanced - Entity Framework\homework\EF Code First - Book Shop\BookShopSystem\Import\authors.csv");
            // Foreach all authors and add them to database.C:\softuni\Databases Advanced - Entity Framework\homework\EF Code First - Book Shop\BookShopSystem\Import\authors.csv
        ...
        private static void SeedBooks(BookShopContext context)
        {
            ...
            string[] books = File.ReadAllLines(@"C:\softuni\Databases Advanced - Entity Framework\homework\EF Code First - Book Shop\BookShopSystem\Import\books.csv");
        ...
        private static void SeedCategories(BookShopContext context)
        {
            ...
            string[] categories = File.ReadAllLines(@"C:\softuni\Databases Advanced - Entity Framework\homework\EF Code First - Book Shop\BookShopSystem\Import\categories.csv");
